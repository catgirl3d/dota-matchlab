...
export const translations = {
  en: {
    ...
    killHistoryEyebrow: 'COMBAT / CHRONICLE',
    killHistoryTitle: 'Kill history',
    killHistoryListAriaLabel: 'Kill history events',
    killHistoryHeroFilter: 'Hero',
    killHistoryAllHeroes: 'All heroes',
    killHistoryEmpty: 'No kills recorded.',
    killHistoryFilteredEmpty: 'No kills for this hero.',
    killHistoryUnavailable: 'Kill history unavailable.',
    ...
    scoreboardTeamPerformance: 'Team performance',
    scoreboardTeamTotalsPreview: 'Prototype metric',
    scoreboardTeamTotalsKda: 'KDA',
    scoreboardTeamTotalsEconomy: 'Economy',
    scoreboardTeamTotalsFarm: 'Farm',
    scoreboardTeamTotalsDamage: 'Damage',
